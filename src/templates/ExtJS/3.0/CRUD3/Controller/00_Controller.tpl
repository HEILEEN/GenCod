...
public class C$Table0.objName$ extends Controller {
	 ...
	 * @value start =limite inferior del rango de la lista de registros a mostrar en la consulta
	 * @value limit =limite superior del rango de la lista de registros a mostrar en la consulta
	 * @value sort  =atributo por el cual se debe ordenar la consulta
	 * @value dir   =direccion del ordenamiento de la consulta
	 * @value filter=filtros por las cuales el usuario quiere realizar cierta busqueda en ciertos campos
	 * @throws Exception
	 */
	...
	$Columns0:{c|$if(c.isFK)$
	/**
	 * Metodo de consulta para las llaves foraneas tabla $c.fkObjTable$
	 * 
	 * @throws Exception
	 */	
	@ActionAnnotation(action=true, permisions = {"APP_$Table0.permission$_ALL", "APP_$Table0.permission$_READ", "ROLE_ADMINISTRATOR"})
	...
	/**
	 * Metodo para borrar permanentemente
	 * 
	 * @throws Exception
	 */	
	...
	/**
	 * Metodo para exportar a excel los datos de la interfaz
	 * 
	 * @value start =limite inferior del rango de la lista de registros a mostrar en la consulta
	 * @value limit =limite superior del rango de la lista de registros a mostrar en la consulta
	 * @value sort  =atributo por el cual se debe ordenar la consulta
	 ...
	 * 
	 * @param cabecera = es la cabecera de la tabla, los titulos de cada columna
	 * @value lDetalle = los datos de la consulta
	 * @value outw     = el archivo para asi escribir los datos sobre el mismo 
	 * @throws Exception
	 */		
